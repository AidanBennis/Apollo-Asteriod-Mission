...
mu_sun = 1.33e+11; % Gravitational parameter of the Sun in km^3/s^2
    ...
    a = 1.503431e+8; % Semi-major axis in km (1 AU)
    e = 0.3340273164747916; % Eccentricity
    i = 1.429702447576273 * conv_rads	; % Inclination in radians
    Om = 78.3334136970667 * conv_rads; % Longitude of ascending node in radians
    om = 328.1986305219802	 * conv_rads; % Argument of perihelion in radians
    Mo = 332.9348459646463	 * conv_rads; % Mean anomaly at reference time in radians
