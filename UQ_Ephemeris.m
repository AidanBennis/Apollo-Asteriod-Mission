...
mu_sun = 1.33e+11; % Gravitational parameter of the Sun in km^3/s^2
    ...
    a = 1.368489e+8; % Semi-major axis in km (1 AU)
    e = 0.264681420970339	; % Eccentricity
    i = 1.303181120654554 * conv_rads; % Inclination in radians
    Om = 178.0807046818409 * conv_rads; % Longitude of ascending node in radians
    om = 15.01294332890225 * conv_rads; % Argument of perihelion in radians
    Mo = 195.9178122079355	 * conv_rads; % Mean anomaly at reference time in radians
