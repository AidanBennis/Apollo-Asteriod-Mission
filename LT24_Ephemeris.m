function [kep] = LT24_Ephemeris(time)
...
mu_sun = 1.33e+11; % Gravitational parameter of the Sun in km^3/s^2
    ...
    a = 1.077248e+8; % Semi-major axis in km (1 AU)
    e = 0.4958122357952095	; % Eccentricity
    i = 0.7660334493088022 * conv_rads; % Inclination in radians
    Om = 165.6574911933899	* conv_rads; % Longitude of ascending node in radians
    om = 283.0856990846475 * conv_rads; % Argument of perihelion in radians
    Mo = 17.11413341956719	 * conv_rads; % Mean anomaly at reference time in radians
